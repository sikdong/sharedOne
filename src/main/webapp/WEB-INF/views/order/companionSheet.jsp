    ...
    <div class="container order-report-content">
        ...
        <div class="row">
            ...
            <table style="border: 1px solid black;">
                <tbody>
                  ...
                  <tr>
                    <th class="n-th">주문번호</th>
                    <td>${orderHeader.orderCode }</td>
                    <th class="n-th">기안자</th>
                    <td>${orderHeader.writer }</td>
                  </tr>
                  <tr>
                    <th class="n-th">기안일자</th>
                    <td>${orderHeader.inserted }</td>
                    <th class="n-th">납기요청일</th>
        ...
        <div class="row">
            <table style="border: 1px solid black;">
                <tbody>
                  <tr>
                    <th class="n-th">바이어</th>
                    <td>${buyer.buyerName }</td>
                    <th class="n-th">대표자</th>
                    <td>${buyer.manager }</td>
                  </tr>
                  <tr>
                    <th class="n-th">국가</th>
        ...
        <div class="row">
            ...
            <table class="detail-table" style="border: 1px solid black;">
                <thead>
                  <tr>
                    <th class="d-d-th" ></th>
                    <th colspan="3" class="d-d-th">제품정보</th>
                    <th colspan="3" class="d-d-th">금액정보</th>
                    
                  </tr>
                  <tr>
                    <th class="d-n-th">번호</th>
                    <th class="d-n-th">제품명</th>
                    <th class="d-n-th">규격</th>
                    <th class="d-n-th">단위</th>
                    <th class="d-n-th">단가</th>
                    <th class="d-n-th">수량</th>
                    <th class="d-n-th">합계액</th>
                  </tr>  
                </thead>
                <tbody id="tbody">
                  ...
                  <tr>
                    <th class="d-n-th "  colspan="4">총합</th>
        ...
        <label for="" class="mt-3 mb-3" style="font-size: 20px; font-weight: bold;"> <i class="fa-regular fa-comment"></i> comment</label>
          <div class="row mb-3 comment-box" style="margin-left: 1px;">
              <span><i class="fa-solid fa-user"></i> 팀장</span>
              <br>
              <p class="mt-3">${orderHeader.comment }</p>
          </div>
    </div>
	<!-- 종결 모달 -->
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h1 class="modal-title fs-5" id="exampleModalLabel">종결 확인</h1>
